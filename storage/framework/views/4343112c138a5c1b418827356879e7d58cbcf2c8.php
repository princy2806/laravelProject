					...
					<li>
						<div class="row" id="row1">
							<div class="col-md-2">
								<div class="file-left">
									<a href="#" >
										<img class="img-zoom file-img" src="<?php echo e('http://127.0.0.1:8000/bookimages/' . $b->bcover); ?>" alt="<?php echo e($b->bname); ?>" title="<?php echo e($b->bname); ?>" id="img1" style="z-index: 10; border-radius: 3px 0px 0px 3px; width: 71px; height: 98px; margin-left: 0px; margin-top: 0px;">
									</a>
...
<?php echo $__env->make("layout.user", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ansh\pdfdrive 27-2\resources\views/home/index.blade.php ENDPATH**/ ?>