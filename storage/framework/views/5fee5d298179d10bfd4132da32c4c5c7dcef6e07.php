...
<nav class="navbar">
  <div class="container-fluid">
    ...
    <button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="seabtn">Search</button>
	  ...
	  <li>
	  <?php echo e(session()->get('uname')); ?><a href="home/logout"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
...
</html><?php /**PATH G:\pdfdrive 27-2\resources\views/home/about.blade.php ENDPATH**/ ?>