  ...
  <div class="container-fluid">
    ...
    <button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="seabtn">Search</button>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="home/signin"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
      </ul>
    </div>
  </div>
...
<div class="container-fluid text-center">    
  <div class="row content">
	...
	<div class="col-md-3"> 
		...
		<a href="#"><h4 id="h4">Pdfdrive:hope Give books away. Get books you want.</h4></a>
		<ul>
		...
		<li>
		<a href="http://127.0.0.1:8000/home/<?php echo e($c->id); ?>/catview">
		<img class="img-polaroid" src="http://127.0.0.1:8000/<?php echo e('catimages/' . $c->caticon); ?>" height="50px" width="50px" alt="category"  id="img2"/>
		<p id="pragraph"><?php echo e($c->catname); ?></p>
		</a>
...
</html><?php /**PATH D:\Mansi\laravel\pdfdrive3\resources\views/layout/user.blade.php ENDPATH**/ ?>