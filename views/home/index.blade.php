					...
					<li>
						<div class="row" id="row1">
							<div class="col-md-2">
								<div class="file-left">
									<a href="#" >
										<img class="img-zoom file-img" src="{{'http://127.0.0.1:8000/bookimages/' . $b->bcover}}" alt="{{$b->bname}}" title="{{$b->bname}}" id="img1" style="z-index: 10; border-radius: 3px 0px 0px 3px; width: 71px; height: 118px; margin-left: 0px; margin-top: 0px;">
									</a>
							...
							<div class="col-md-7">
								...
								<h5><a href="home/{{$b->id}}/view">Details</a></h5>
